      ...
      <div className="max-w-1320px mx-auto py-[8px] px-[40px] mb-[0px]">
        <div className=" middle  rounded-t-xl border pb-[30px] ">
          ...
          <form className=" py-[10px] px-[20px]">
            ...
            <h1 className="pb-[20px] mt-4 font-semibold"> Image Animation </h1>
            <input
              class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
              id="file_input"
              type="file"
            ...
            <h1 className="pb-[20px] font-semibold ">Select Sub Category</h1>
            <select
              id="countries"
            ...
            <Button className="bg-violet-700">Add Product</Button>
          </form>
        </div>
      </div>
    </div>
